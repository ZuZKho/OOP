...
/**
 * Class to render tasks results to html.
 */
public class Renderer {

    /**
     * Process tasks restuls.
     *
     * @param tasks tasks info.
     * @param tasksResults task results info.
     */
    public static void render(List<Task> tasks, HashMap<Student,
        ...
        try {
            ...
            for (var entry : tasksResults.entrySet()) {
                String mark = entry.getValue()
                        ...
                        .stream()
                        .map(result ->
                                result.getMark()).reduce(0.0f, Float::sum)
                        .toString();
            ...
            Writer out = new OutputStreamWriter(
                    new FileOutputStream("src/main/resources/index.html"));

 ...
 * Это накладывает многие ограничения. Так как пользователь не может обращатья по значению.
 * Из за этого ввод графа довольно некрасивый,
 ...
 *            чтобы алгоритм нахождения кратчайшего расстояния мог делать
 *            операции сложения и сравнения.
